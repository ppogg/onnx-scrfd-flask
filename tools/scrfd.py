...
if __name__ == '__main__':
    detector = SCRFD(model_file=r'E:\pytorch\scrfd\onnx/scrfd_500m.onnx')
    detector.prepare(-1)
    # img_paths = r'E:\pytorch\scrfd/sample'
    # files = os.listdir(img_paths)
    # for file in files:
    #     img_path = os.path.join(img_paths, file)
